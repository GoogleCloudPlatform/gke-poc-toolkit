...
The scripts provided in this repository require a baseline set of information, including the GCP Region, Zone and Project to be used when creating the GKE cluster. A template environment variables file is included in the root of this repository. The section below outline the required and optional variable information, including default values
