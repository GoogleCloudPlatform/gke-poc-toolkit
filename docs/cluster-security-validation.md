...
Run the [./scripts/create_and_validate_demo_rbac_users.sh](../scripts/create_and_validate_demo_rbac_users.sh) script located in the [scripts directory](../scripts/) to create a demo auditor and editor RBAC user in each cluster. Once created, the script also validates the of these accounts in each cluster. 
